...
class AntColonySolver:
    def __init__(self,
                 ...
                 ant_count=128,            # this is the bottom of the near-optimal range for numpy performance
                 ant_speed=1,             # how many steps do ants travel per epoch

                 distance_power=1,        # power to which distance affects pheromones                 
                 pheromone_power=0.5,    # power to which differences in pheromones are noticed
...
#funzioni per calcolare distanze 
